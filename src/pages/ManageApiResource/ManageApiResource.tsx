...
const initialState : ApiResourceState = {
    apiResourceId:0,
    header:'',
    apiResource: { id:0,allowedAccessTokenSigningAlgorithms:'',created:'',description:'',displayName:'',enabled:true,
        lastAccessed:'',name:'',nonEditable:false,updated:null,showInDiscoveryDocument:false }
}
